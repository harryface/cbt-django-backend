...
from core.models import Exam, Answer
from .serializers import (
    AnswerSerializer, ExamSerializerwithQuestions, RegisterStudentsSerializer,
...
class AnswerGenericAPIView(viewsets.ModelViewSet):
