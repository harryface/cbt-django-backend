...
class AnswerSerializer(serializers.ModelSerializer):
    '''
    Answer serializer, displays link to the exam, id of taker
    and full question instance
    '''

    exam = serializers.HyperlinkedIdentityField(view_name='exam-detail')
    taker = serializers.PrimaryKeyRelatedField()

    class Meta:
        model = Answer
        fields = ['id', 'exam', 'taker', 'question', 'taker_choice', 'is_correct']
        depth = 1
